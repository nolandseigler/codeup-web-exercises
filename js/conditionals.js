 ...
 * Yes I can. Keep ALERTS OR USE RETURN??
 */
var isEnterNumber = confirm("Would you like to enter a number?");
if (isEnterNumber) {
    ...
    var userInputNumber = parseInt(prompt("Please enter a whole number."));
    numberDetailsFunction(userInputNumber);
