...
//         return newArr
//     });
//     var sortedArr = newArr.sort(sortNumber);
//     console.log(sortedArr);
// }
// filterNumbers(["fred", true, 34, 31, 11, 1, 2, 25, 7, 69, 45, "32", "10"]);
//     ```js
...
// const washCars = function (inputArr) {
//     inputArr.forEach(element => {
...
//
// const adminList = function (inputArr) {
//     var listOfAdmins = [];
//     inputArr.forEach( element => {
//         if (element.isAdmin) {
//             listOfAdmins.push(element);
//         }
//     return listOfAdmins;
//     })
// return listOfAdmins;
