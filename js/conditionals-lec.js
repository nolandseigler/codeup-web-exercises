...
const trafficLightAdvice = function (trafficLightColor) {
    if (typeof trafficLightColor === "string") {
        trafficLightColor.toLowerCase();
        if (trafficLightColor === "red") {
            return "Stop your vehicle behind the white line and wait until the light turns green.";
        } else if (trafficLightColor === "yellow" || trafficLightColor === "amber") {
            return "Use caution when clearing intersection. Light will turn red soon. Do not speed up. Prepare to stop.";
        } else if (trafficLightColor === "green") {
            return "You have the right of way. Proceed through the intersection at the appropriate speed. Be mindful of crosswalks.";
        } else {
            return "That is not a traffic light color.";
        }
    } else {
        return "That is not a traffic light color. Please resubmit your response."
    }
}
var trafficLightColor = prompt("What color is the traffic light?");
trafficLightAdvice(trafficLightColor);
console.log(trafficLightAdvice(trafficLightColor));
