...
// var confirmExit;
// while (!confirmExit) {
//     confirmExit = confirm("Would you like to exit?");
// };
//
//
...
// do {
//     var colorPrompt = prompt("Input a color.");
...
for (var i = 1; i <= 100; i++) { i % 3 === 0 && i % 5 === 0 ? console.log("FizzBuzz") : i % 3 === 0 ? console.log("Fizz") : i % 5 === 0 ? console.log("Buzz") : console.log(i);}
